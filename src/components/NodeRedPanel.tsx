...
export function NodeRedPanel() {
  ...
  const [selectedEvent, setSelectedEvent] = useState<NodeRedEvent | null>(null);
            ...
            {events.slice(0, 25).map((evt) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-[11px] transition-colors text-left cursor-pointer ${
